	...
	$: {
		...
		stages = [
			...
			},
			{
				type: 'round',
				name: '1-й раунд',
				comments: 'продолжительность пакета 3 - 5 часов (смотря как вы играете )',
				themes: [
					{
						name: 'С Новым годом!',
						questions: [
			...
			},
			{
				...
				fragments: [
					[
						{
							type: 'text',
							value: 'назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, назовите игру  из игротеки по картинке, ',
						},
						{
							type: 'image',
